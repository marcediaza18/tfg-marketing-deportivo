...
export async function listAthletes(params?: { q?: string; status?: string }): Promise<{ items: Athlete[]; total: number }> {
...
export async function createAthlete(payload: Partial<Athlete>): Promise<Athlete> {
